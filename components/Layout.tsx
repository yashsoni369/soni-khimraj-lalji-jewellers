  ...
  return (
    <div className="sticky top-0 z-50" style={{ margin: 0, padding: 0 }}>
      ...
      <header
        ...
        style={{ margin: 0 }}
      >
        <div className="container mx-auto px-4 md:px-12 flex items-center justify-between lg:justify-center relative h-16 md:h-20 lg:h-24">

          {/* MOBILE: Hamburger Menu Button */}
          <div className="lg:hidden flex-shrink-0">
            <button
              onClick={() => setIsMenuOpen(!isMenuOpen)}
              className="p-2 text-maroon-900 focus:outline-none -ml-2"
          ...
          <div className="flex items-center gap-2 lg:gap-3 z-50 lg:absolute lg:right-12">
            <button
              onClick={() => openWhatsApp(createEnquiryMessage())}
              className="flex items-center gap-2 text-maroon-900 hover:text-gold-600 transition-colors bg-cream-50 hover:bg-gold-50 px-3 md:px-4 py-1.5 md:py-2 rounded-sm border border-maroon-200"
            >
              <img
              ...
              <span className="md:hidden text-xs font-medium">Contact</span>
            </button>
          </div>
